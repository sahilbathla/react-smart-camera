...
class Camera extends Component {
      ...
      navigator.mediaDevices.getUserMedia({ video, audio })
        .then((mediaStream) => {
          ...
          if (this.video) {
            ...
            throw 'Video Tag not initialized';
          }
        })
  ...
  render() {
    return (
      <div style={{ ...(this.props.styles.videoContainer || {}), ...styles.default.videoContainer}} ref={(videoContainer) => { this.videoContainer = videoContainer; }}>
    { this.props.children }
  <canvas ref={(canvas) => { this.canvas = canvas; }}></canvas>
    <video style={{ ...(this.props.styles.video || {}), ...styles.default.video }} ref={(video) => { this.video = video; }} />
    </div>
  );
  }
}
