This project is a demo of [React Camera Extended](https://github.com/decabits/react-camera-extended) bootstrapped with [Create React App](https://github.com/facebook/create-react-app).
